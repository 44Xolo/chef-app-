 ...
 */
type Course = 'Mains' | 'Starters' | 'Desserts' | 'Drinks';
...
// =================================================================
// Image Mappings (For placeholders - Updated to reflect user's menu items)
// =================================================================
const imageMap: { [key: string]: string } = {
  'Rib King Ribs': 'https://www.thespruceeats.com/thmb/mfv2o5S1cbud5i_U-iLgN2w885s=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/oven-barbecue-ribs-335605-hero-01-a7e62d65ed3b488c8d393a7a6a433a7c.jpg', // Dark Red
  'Caesar Salad': 'https://images.services.kitchenstories.io/h34bAY5g3o-Bwdi3L6x-hS24c-I=/1080x0/filters:quality(80)/images.kitchenstories.io/wagtailOriginalImages/R2568-final-photo-3.jpg', // Green
  'Chocolate Lava Cake': 'https://www.livewellbakeoften.com/wp-content/uploads/2021/02/Chocolate-Lava-Cakes-for-Two-3.jpg', // Brown
  'Fresh Orange Juice': 'https://www.alphafoodie.com/wp-content/uploads/2020/11/Orange-Juice-1-of-1.jpeg', // Orange
  'Grilled Salmon': 'https://www.seriouseats.com/thmb/O2-mon24oA92nS2_2p4y0iK2f0g=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/grilled-salmon-fillets-hero-2-18b55562ee4c4075842ad7f1b8031442.jpg', // Cyan
  'Garlic Breadsticks': 'https://www.allrecipes.com/thmb/a-vrp_Y2ole_s21q9mc3Y-n23Co=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/14304-soft-garlic-breadsticks-DDMFS-4x3-0188-f945494c986c421e8b37996f2a33bc12.jpg', // Yellow
  'Burger Deluxe': 'https://www.foodandwine.com/thmb/DI29Houjc_ccAtFKly0BbVsusHc=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/crispy-comte-cheesburgers-FT-RECIPE0921-6166c6552b7148e8a8561f77657f540a.jpg' // Deep Orange
};
      ...
      @switch (currentPage()) {
        @case ('welcome') {
          ...
          <div class="h-screen flex flex-col justify-center items-center p-8 text-center">
              <img src="https://www.firmdalehotels.com/media/images/originals/ham-yard-hotel-london-restaurant-bar-orangery-1.jpg" alt="Atero Eats Restaurant" class="w-full max-w-xs h-48 object-cover rounded-xl mb-6 shadow-lg">
...
export class App {
  ...
  menuItems = signal<MenuItem[]>([
    { id: 1, name: "Rib King Ribs", description: "Slow cooked ribs with smoky BBQ sauce.", course: "Mains", price: 250.00, image: imageMap['Rib King Ribs'], available: true },
    { id: 2, name: "Caesar Salad", description: "Romaine lettuce, croutons, parmesan, Caesar dressing.", course: "Starters", price: 95.00, image: imageMap['Caesar Salad'], available: true },
    { id: 3, name: "Chocolate Lava Cake", description: "Warm molten chocolate cake with vanilla ice cream.", course: "Desserts", price: 75.00, image: imageMap['Chocolate Lava Cake'], available: true },
    { id: 4, name: "Fresh Orange Juice", description: "Freshly squeezed, no sugar added.", course: "Drinks", price: 45.00, image: imageMap['Fresh Orange Juice'], available: true },
    { id: 5, name: "Grilled Salmon", description: "Served with asparagus and lemon butter sauce.", course: "Mains", price: 180.00, image: imageMap['Grilled Salmon'], available: true },
    { id: 6, name: "Garlic Breadsticks", description: "Toasted bread with garlic butter and herbs.", course: "Starters", price: 60.00, image: imageMap['Garlic Breadsticks'], available: false },
    { id: 7, name: "Burger Deluxe", description: "Wagyu patty, cheddar, lettuce, tomato, special sauce.", course: "Mains", price: 165.00, image: imageMap['Burger Deluxe'], available: true },
  ]);
  ...
  /** @type {Signal<string | null>} Selected payment method (Card, Cash, Voucher). */
  ...
  orderNumber = signal<number>(Math.floor(Math.random() * 90000) + 10000); // 5-digit order number

  /** @type {Course[]} Constant list of available courses. */
  courses: Course[] = ['Mains', 'Starters', 'Desserts', 'Drinks'];

  /** @type {string[]} Constant list of payment options. */
  paymentMethods: string[] = ['Card', 'Cash', 'Voucher'];
  ...
  clearCartAndStartNewOrder(paymentType: string): void {
    this.cartItems.set([]);
    this.paymentMethod.set(paymentType);
  ...
  handleAddItemClick(name: string, description: string, course: string, price: string): void {
    ...
    const newItem: MenuItem = {
      ...
      price: priceNum,
      image: 'https://i.pinimg.com/736x/2d/5c/77/2d5c77c3837c39eaa9c3137b52c6753f.jpg', // Placeholder for new items. [1]
      available: true
    };
